...
export const metadata = {
    title: "Ensaio de Permeabilidade e Estanqueidade | MMC LAB",
    description: "Certifique a estanqueidade à água de vedações verticais, esquadrias e fachadas in loco em conformidade com as exigências da norma de desempenho ABNT NBR 15575-4.",
};

export default function EnsaioPermeabilidadePage() {
    return (
        <div className="bg-background-light dark:bg-slate-950 text-slate-700 dark:text-slate-300 min-h-screen transition-colors duration-300 flex flex-col pt-[80px] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col">
                <EnsaioHeroBanner 
                    ...
                    breadcrumbCurrent="Permeabilidade e Estanqueidade"
                    imageSrc="/images/ensaios/permeabilidade.jpeg"
                    imageAlt="Fundo Permeabilidade e Estanqueidade"
                />
                    ...
                    <div className="max-w-[1280px] mx-auto px-6 relative z-10">
                            ...
                            <div className="lg:col-span-7 space-y-8">
                                <div className="space-y-4">
                                    <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-950 dark:text-white tracking-tight leading-tight">
                                        Garantia de Estanqueidade à Água em Fachadas e Sistemas de Vedação
                                    </h2>
                                ...
                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    O <strong>Ensaio de Permeabilidade e Estanqueidade à Água in loco</strong> avalia o comportamento de vedações verticais (paredes externas, fachadas e esquadrias) sob chuva direcionada induzida para identificar e prevenir falhas de estanqueidade estrutural e infiltrações indesejadas na parte interna de edificações comerciais e residenciais.
                                </p>

                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    A estanqueidade é um requisito crítico da norma de desempenho <strong>ABNT NBR 15575-4</strong>, que estabelece critérios claros de durabilidade e habitabilidade. Através de um pórtico de aspersão calibrado contendo bicos aspersores normatizados, nossa equipe impõe jatos contínuos e controlados de chuva diretamente sobre a face externa do sistema sob análise, aferindo a capacidade do conjunto estrutural em conter a penetração de água sem apresentar manchas de umidade, gotejamento ou infiltração.
                                </p>

                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    Realizar o teste in loco é essencial para a homologação e recebimento técnico de sistemas construtivos inovadores (drywall externo, light steel framing, paredes de concreto moldadas in loco, alvenarias revestidas ou cortinas de vidro). Trata-se da única ferramenta prática e objetiva para certificar as boas práticas de execução de juntas, acabamentos de esquadrias e selagens externas antes da conclusão da obra.
                                </p>
                            ...
                            <div className="lg:col-span-5 space-y-8">
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-4 shadow-md group">
                                    <div className="relative aspect-video w-full rounded-2xl overflow-hidden shadow-inner bg-slate-100 dark:bg-slate-950">
                                        <img
                                            src="/images/ensaios/permeabilidade.jpeg"
                                            alt="Permeabilidade e Estanqueidade"
                                            className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                                        />
                                    </div>
                                    <div className="mt-4 px-2">
                                        <h4 className="text-base font-bold text-slate-900 dark:text-white">
                                            Prevenção e Durabilidade in loco
                                        </h4>
                                        <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 font-bold">
                                            Ensaios de aspersão contínua em fachadas e vedações verticais para garantia contra infiltrações.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 p-6 rounded-3xl space-y-4">
                                    ...
                                    <ul className="space-y-3.5 text-sm font-semibold text-slate-600 dark:text-slate-300">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <span>Paredes e Fachadas: <strong>ABNT NBR 15575-4</strong></span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <span className="material-symbols-outlined text-[#00bfa5] text-[20px]">assignment</span>
                                            <span>Estanqueidade de Esquadrias: <strong>ABNT NBR 10821</strong></span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <span className="material-symbols-outlined text-[#00bfa5] text-[20px]">shield</span>
                                            <span>Verificações: <strong>Manchas de Umidade e Infiltração</strong></span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <span className="material-symbols-outlined text-[#00bfa5] text-[20px]">place</span>
                                            <span>Método: <strong>Aspersão Hidráulica Contínua in loco</strong></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="mt-24 space-y-12">
                            <div className="text-center max-w-3xl mx-auto space-y-3">
                                ...
                                <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-semibold">
                                    Entenda nosso procedimento de aspersão normatizada in loco para atestar a segurança hídrica da sua obra.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-[#00bfa5]/40 transition-all duration-300 shadow-sm flex flex-col justify-between hover:shadow-[0_15px_30px_rgba(0,191,165,0.06)] hover:-translate-y-1">
                                    <div className="space-y-6">
                                        ...
                                        <h4 className="text-xl font-bold text-slate-900 dark:text-white">
                                            Montagem do Pórtico de Aspersão
                                        </h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                            Fixação da estrutura do pórtico com bicos aspersores calibrados voltada para a face externa da vedação. A distância entre a grelha de aspersão e a fachada é meticulosamente ajustada de acordo com as especificações da norma, garantindo que toda a área amostral receba um fluxo homogêneo e linear de jatos de água.
                                        </p>
                                    </div>
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-[#00bfa5]/40 transition-all duration-300 shadow-sm flex flex-col justify-between hover:shadow-[0_15px_30px_rgba(0,191,165,0.06)] hover:-translate-y-1">
                                    <div className="space-y-6">
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                            Inicia-se a indução de chuva simulada ininterrupta por meio de bomba d&apos;água acoplada a rotâmetros industriais. O teste expõe o sistema a vazões de água normatizadas (por exemplo, 2 L/m²·minuto) simulando temporais severos com vento sob forte estresse climático durante o período estipulado.
                                        </p>
                                    </div>
                                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800/80">
                                        <span className="text-[10px] font-bold text-[#00bfa5] dark:text-teal-400 uppercase tracking-widest bg-[#00bfa5]/10 px-2.5 py-1 rounded-md">
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-[#00bfa5]/40 transition-all duration-300 shadow-sm flex flex-col justify-between hover:shadow-[0_15px_30px_rgba(0,191,165,0.06)] hover:-translate-y-1">
                                    <div className="space-y-6">
                                        ...
                                        <h4 className="text-xl font-bold text-slate-900 dark:text-white">
                                            Mapeamento e Inspeção Interna
                                        </h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                            Enquanto a face externa é submetida à aspersão, engenheiros posicionados no interior da edificação monitoram a face interna. Inspeções táteis e análises térmicas infravermelhas detectam precocemente manchas de umidade ou acúmulo hídrico oculto, resultando em um laudo conclusivo com anotação técnica (ART).
                                        </p>
                                    </div>
                                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800/80">
                                        <span className="text-[10px] font-bold text-[#00bfa5] dark:text-teal-400 uppercase tracking-widest bg-[#00bfa5]/10 px-2.5 py-1 rounded-md">
                                            DIAGNOSTICO E LAUDO
                                                ...
                                                <EnsaioCarousel ensaioId="campo-permeabilidade" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Pórticos e cúpulas de aspersão com controle microprocessado de vazão e pressão estática, oferecendo repetibilidade perfeita.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-bold text-slate-900 dark:text-white text-lg">Rigor de Calibração RBC</h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Medidores de vazão (rotâmetros) e manômetros de pressão rigorosamente aferidos por laboratórios pertencentes à Rede Brasileira de Calibração.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-bold text-slate-900 dark:text-white text-lg">Inspeções Não Destrutivas</h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            A MMC LAB combina o ensaio mecânico tradicional de aspersão com termografia infravermelha avançada para identificar focos internos de infiltração sem danificar as vedações.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Fornecemos ensaios complementares de desempenho, acústica predial, ensaios de guarda-corpos e de resistência de aderência de revestimento de fachadas.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-24 text-center max-w-3xl mx-auto relative z-10 bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 p-8 sm:p-12 rounded-[2rem] shadow-sm">
                            <h4 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-4">
                                Precisa realizar o Ensaio de Permeabilidade ou Estanqueidade?
                            </h4>
