        ...
        <div className="bg-background-light dark:bg-slate-950 text-slate-700 dark:text-slate-300 min-h-screen transition-colors duration-300 flex flex-col pt-[80px] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col">
                <EnsaioHeroBanner 
                    ...
                    title="Impacto de Corpo Mole e Corpo Duro"
                    breadcrumbCurrent="Impacto de Corpo Mole e Duro"
                    imageSrc="/images/ensaios/impacto.jpeg"
                    imageAlt="Fundo Impacto de Corpo Mole e Corpo Duro"
                />
