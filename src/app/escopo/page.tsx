            ...
            <main className="max-w-7xl mx-auto px-6 pt-16">
                <div className="flex flex-col md:flex-row gap-16 items-center">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <div className="space-y-6 text-lg text-slate-500 font-medium leading-relaxed border-l-2 border-primary/50 pl-6">
                            <p>
                    ...
                    <div className="md:w-1/2 grid grid-cols-2 gap-4">
                        <div className="bg-white border border-slate-200 p-8 rounded-2xl flex flex-col items-center justify-center text-center shadow-sm hover:border-primary/30 hover:-translate-y-1 transition-all aspect-square group">
                            ...
                            <span className="font-extrabold text-slate-900">Métodos Normalizados</span>
                        </div>
                        <div className="bg-white border border-slate-200 p-8 rounded-2xl flex flex-col items-center justify-center text-center shadow-sm hover:border-primary/30 hover:-translate-y-1 transition-all aspect-square group">
                            <div className="w-14 h-14 rounded-xl bg-primary/10 text-primary flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                <span className="material-symbols-outlined text-[32px]">inventory_2</span>
                            </div>
                            <span className="font-extrabold text-slate-900">Procedimentos Validados</span>
                        </div>
                        <div className="bg-white border border-slate-200 p-8 rounded-2xl flex flex-col items-center justify-center text-center shadow-sm hover:border-secondary/50 hover:-translate-y-1 transition-all aspect-square col-span-2 group">
                            ...
                            <span className="font-extrabold text-xl mb-2 text-slate-900">Rastreabilidade Metrológica</span>
                            <p className="text-sm text-slate-500 font-medium">Garantia absoluta de pessoal competente e equipamentos rigorosamente calibrados para fins Inmetro.</p>
                        </div>
                    </div>
