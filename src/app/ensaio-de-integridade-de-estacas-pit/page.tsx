        ...
        <div className="bg-background-light dark:bg-slate-950 text-slate-700 dark:text-slate-300 min-h-screen transition-colors duration-300 flex flex-col pt-[80px] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col">
                <EnsaioHeroBanner 
                    ...
                    title="Ensaio de Integridade de Estacas (PIT)"
                    breadcrumbCurrent="Integridade de Estacas (PIT)"
                    imageSrc="/images/ensaios/pit.jpeg"
                    imageAlt="Fundo Ensaio de Integridade de Estacas (PIT)"
                />
