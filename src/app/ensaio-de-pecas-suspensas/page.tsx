...
export const metadata = {
    title: "Ensaio de Peças Suspensas | MMC LAB",
    description: "Certifique a capacidade de carga de vedações verticais (paredes e divisórias) sob mobiliários e redes de dormir in loco em conformidade com as exigências da norma de desempenho ABNT NBR 15575-4.",
};

export default function EnsaioPecasSuspensasPage() {
    return (
        <div className="bg-background-light dark:bg-slate-950 text-slate-700 dark:text-slate-300 min-h-screen transition-colors duration-300 flex flex-col pt-[80px] overflow-hidden">
            ...
            <main className="flex-1 flex flex-col">
                <EnsaioHeroBanner 
                    ...
                    breadcrumbCurrent="Peças Suspensas"
                    imageSrc="/images/ensaios/pecas-suspensas.jpeg"
                    imageAlt="Fundo Ensaio de Peças Suspensas"
                />
                    ...
                    <div className="max-w-[1280px] mx-auto px-6 relative z-10">
                            ...
                            <div className="lg:col-span-7 space-y-8">
                                <div className="space-y-4">
                                    <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-950 dark:text-white tracking-tight leading-tight">
                                        Validação de Resistência e Suporte a Cargas de Serviço de Mobiliários e Redes
                                    </h2>
                                ...
                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    O <strong>Ensaio de Peças Suspensas in loco</strong> avalia o comportamento mecânico das paredes internas, divisórias leves e sistemas drywall quando submetidos a cargas verticais e esforços de arrancamento decorrentes da fixação de armários, prateleiras pesadas, suportes de TV ou redes de dormir.
                                </p>

                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    Conforme estabelecido pela norma de desempenho <strong>ABNT NBR 15575-4</strong>, as vedações verticais devem apresentar estabilidade mecânica sob ações transmitidas por peças suspensas, garantindo que o sistema não sofra fissuração prejudicial superior a 0,2 mm, folgas estruturais nas fixações, envergamento ou colapso do substrato construtivo.
                                </p>

                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    Esse teste simula as condições severas de uso através da aplicação de cargas estáticas de forma excêntrica e progressiva. Para validação de armários de cozinha e prateleiras, o ensaio emprega suportes mecânicos normatizados associados a massas padrão (geralmente entre 120 kgf e 180 kgf) suspensos por tempo pré-determinado (tipicamente 24 horas). No caso de punhos e ganchos de redes de dormir, aplicam-se esforços verticais e horizontais simulando o balanço de usuários de modo a assegurar que o sistema estrutural suporte a tração sem cisalhamento ou desprendimento.
                                </p>

                                <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium leading-relaxed text-justify">
                                    Realizar o ensaio de peças suspensas in loco é altamente recomendado para homologação de novos métodos construtivos, auditorias pós-obra e recebimento de apartamentos, fornecendo laudo estatisticamente seguro de que as soluções de fixação de gesso acartonado e alvenarias estruturais estão aptas para a rotina diária dos moradores.
                                </p>
                            ...
                            <div className="lg:col-span-5 space-y-8">
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-4 shadow-md group">
                                    <div className="relative aspect-video w-full rounded-2xl overflow-hidden shadow-inner bg-slate-100 dark:bg-slate-950">
                                        <img
                                            src="/images/ensaios/pecas-suspensas.jpeg"
                                            alt="Ensaio de Peças Suspensas"
                                            className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                                        />
                                    </div>
                                    <div className="mt-4 px-2">
                                        <h4 className="text-base font-bold text-slate-900 dark:text-white">
                                            Estabilidade sob Peças Suspensas
                                        </h4>
                                        <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 font-bold">
                                            Cargas estáticas excêntricas aplicadas em balanço e testes de tração em ganchos de rede in loco.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 p-6 rounded-3xl space-y-4">
                                    ...
                                    <ul className="space-y-3.5 text-sm font-semibold text-slate-600 dark:text-slate-300">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <span>Sistemas de Vedações: <strong>ABNT NBR 15575-4</strong></span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                        ...
                                        <li className="flex items-center gap-3">
                                            ...
                                            <span>Carga Prateleiras/Armários: <strong>Até 180 kgf Estática</strong></span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <span className="material-symbols-outlined text-[#00bfa5] text-[20px]">place</span>
                                            <span>Carga Gancho de Rede: <strong>Até 150 kgf Estática</strong></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="mt-24 space-y-12">
                            <div className="text-center max-w-3xl mx-auto space-y-3">
                                <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-950 dark:text-white">
                                    Etapas do Ensaio de Peças Suspensas
                                </h3>
                                <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-semibold">
                                    Como avaliamos e certificamos a fixação segura de cargas pesadas nas paredes da sua obra.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-[#00bfa5]/40 transition-all duration-300 shadow-sm flex flex-col justify-between hover:shadow-[0_15px_30px_rgba(0,191,165,0.06)] hover:-translate-y-1">
                                    <div className="space-y-6">
                                        ...
                                        <h4 className="text-xl font-bold text-slate-900 dark:text-white">
                                            Fixação do Dispositivo e Calibração
                                        </h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                            Instalação dos ganchos ou dos suportes mecânicos normativos com buchas padronizadas ou conforme a especificação do projeto de acabamento. Um relógio comparador digital ou sensor eletromecânico é instalado perpendicularmente à área amostral para capturar as deflexões com precisão micrométrica.
                                        </p>
                                    </div>
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-[#00bfa5]/40 transition-all duration-300 shadow-sm flex flex-col justify-between hover:shadow-[0_15px_30px_rgba(0,191,165,0.06)] hover:-translate-y-1">
                                    <div className="space-y-6">
                                        ...
                                        <h4 className="text-xl font-bold text-slate-900 dark:text-white">
                                            Aplicação Gradual de Cargas de Ensaio
                                        </h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                            Aplicação progressiva das massas aferidas. No caso de prateleiras e armários, aplica-se o torque excêntrico sob a estrutura em balanço. O esforço é mantido sob supervisão contínua durante 24 horas para avaliar os efeitos decorrentes de fluência estrutural ou escorregamento microscópico das ancoragens.
                                        </p>
                                    </div>
                                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800/80">
                                        <span className="text-[10px] font-bold text-[#00bfa5] dark:text-teal-400 uppercase tracking-widest bg-[#00bfa5]/10 px-2.5 py-1 rounded-md">
                                ...
                                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 hover:border-[#00bfa5]/40 transition-all duration-300 shadow-sm flex flex-col justify-between hover:shadow-[0_15px_30px_rgba(0,191,165,0.06)] hover:-translate-y-1">
                                    <div className="space-y-6">
                                        ...
                                        <h4 className="text-xl font-bold text-slate-900 dark:text-white">
                                            Aferição da Deformação Residual
                                        </h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                            Após a descarga total da parede, afere-se o deslocamento residual permanente. Engenheiros seniores inspecionam o local minuciosamente sob lupa óptica de aumento para descartar rupturas locais, desplacamento do miolo do drywall, rachaduras na junta de alvenaria ou folga irreversível nos elementos de fixação.
                                        </p>
                                    </div>
                                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800/80">
                                        <span className="text-[10px] font-bold text-[#00bfa5] dark:text-teal-400 uppercase tracking-widest bg-[#00bfa5]/10 px-2.5 py-1 rounded-md">
                                            ANÁLISE DE CONFORMIDADE
                                                ...
                                                <EnsaioCarousel ensaioId="campo-pecas-suspensas" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Aparelhos sensores micrométricos digitais com taxa de amostragem em tempo real, monitorando deformações por fluência.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Dinâmometros, células de carga e relógios comparadores com calibração rastreável RBC ativa em nosso inventário de engenharia.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-bold text-slate-900 dark:text-white text-lg">Suporte de Laudo Conclusivo</h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Emitimos relatórios analíticos completos com fotos digitais microscópicas detalhando a conformidade normativa e as margens de segurança.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200/50 dark:border-slate-800/60">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="font-bold text-slate-900 dark:text-white text-lg">Soluções Completas de Ensaios</h4>
                                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                                            Realizamos todos os ensaios de desempenho da NBR 15575 (Guarda-corpos, Impacto, Acústica, Estanqueidade, etc.) in loco.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-24 text-center max-w-3xl mx-auto relative z-10 bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 p-8 sm:p-12 rounded-[2rem] shadow-sm">
                            <h4 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-4">
                                Precisa realizar o Ensaio de Peças Suspensas?
                            </h4>
