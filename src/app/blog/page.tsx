            ...
            <main className="flex-1">
                ...
                <section className="relative pt-24 pb-32 overflow-hidden bg-slate-900 border-b border-slate-800">
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        ...
                        <div className="absolute bottom-10 left-10 w-[300px] h-[300px] bg-pink-500/20 rounded-full blur-[80px] mix-blend-screen animate-pulse"></div>
                    </div>

                    <div className="max-w-7xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 text-pink-400 font-bold text-sm mb-6 border border-pink-500/30 backdrop-blur-md shadow-[0_0_15px_rgba(236,72,153,0.3)] hover:shadow-[0_0_25px_rgba(236,72,153,0.5)] transition-all">
