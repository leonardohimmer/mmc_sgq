            ...
            <main className="flex-1">
                ...
                <section className="relative pt-24 pb-32 sm:pt-32 sm:pb-40 overflow-hidden bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white border-b border-slate-200 dark:border-primary/20">
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        ...
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 md:w-[400px] h-64 md:h-[400px] bg-teal-500/10 dark:bg-teal-500/20 rounded-full blur-[60px] md:blur-[80px] mix-blend-multiply dark:mix-blend-screen animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.5s' }}></div>
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 md:w-[200px] h-32 md:h-[200px] bg-emerald-400/15 dark:bg-emerald-400/30 rounded-full blur-[40px] md:blur-[60px] mix-blend-multiply dark:mix-blend-screen animate-pulse" style={{ animationDuration: '4s', animationDelay: '1s' }}></div>
                    ...
                    <div className="max-w-[1280px] mx-auto px-6 sm:px-8 relative z-10 text-center flex flex-col items-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 dark:bg-slate-800/80 text-emerald-600 dark:text-emerald-400 font-semibold text-sm mb-6 md:mb-8 border border-emerald-500/20 dark:border-emerald-500/30 backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.15)] dark:shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.3)] dark:hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] transition-all">
                ...
                <section className="py-24 bg-background-light dark:bg-slate-950 relative">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <div className="md:col-span-2 group bg-cyan-50/30 dark:bg-slate-950/40 border border-cyan-100/80 dark:border-cyan-500/20 rounded-3xl p-10 md:p-14 hover:border-cyan-500/50 transition-all duration-500 shadow-xl hover:shadow-[0_0_50px_rgba(6,182,212,0.15)] dark:hover:shadow-[0_0_50px_rgba(6,182,212,0.2)] relative overflow-hidden flex flex-col md:flex-row items-center gap-12 mt-4">
                                {/* Efeito de grade/radar digital no backgorund */}
                                <div className="absolute inset-0 opacity-[0.08] dark:opacity-20 pointer-events-none" style={{
                                ...
                                <div className="md:w-2/3 relative z-10 text-center md:text-left">
                                    ...
                                    <Link href="/contato" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white dark:text-slate-900 rounded-xl font-bold transition-all shadow-md group-hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] text-base sm:text-lg hover:-translate-y-1">
